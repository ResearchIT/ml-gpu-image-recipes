...
set -e
mkdir /build
dnf install -y git gcc-toolset-11
# ENABLE NEW GCC
source /opt/rh/gcc-toolset-11/enable
curl -fL https://releases.bazel.build/5.3.1/release/bazel-5.3.1-linux-x86_64 -o /usr/bin/bazel
...
export TF_CUDA_TOOLKIT_PATH=/usr/local/cuda-11.7/
