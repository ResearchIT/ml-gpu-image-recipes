...
buildah config --created-by "snehring@iastate.edu" --author "snehring" --label name=centos8-cuda11.0-cudnn8-tensorrt7-python38-tensorflow $container
buildah commit $container centos8-cuda11.0-cudnn8-tensorrt7-python38-tensorflow
buildah rm $container
unset container
